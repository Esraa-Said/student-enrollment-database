...
import {gitAllBtn,createSt,delbtn,onegroupstudentsbtn} from './Groups'
...
export default function Options() {
    ...
    return (
        ...
        <div >
            <button href='#' className='btn btn-lg btn-secondary mb-5' role='button'>Show group Subjects</button>
        </div>
        <div >
