...
export default function Selection() {
	...
	return (
		<div>
			<div className="container-sm m-3 p-3 bg-secondary" style={{ borderRadius: "10px", fontFamily: "cursive", fontSize: "2vw", color: "#ffffff" }}>
			...
			<div className="container mt-5">
				...
				<div className="d-flex flex-wrap justify-content-around align-items-center align-content-around">
					<div className="align-self-center ">
						<a href="select" role="button" className="btn btn-secondary btn-lg" style={{ padding: "1vw", fontSize: "2vw" }} id="btngo" onClick={go}>
							GO
						</a>
					</div>
				</div>
