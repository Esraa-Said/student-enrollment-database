...
export const getAllStudents = async (req, res) => {
    const [data] = await db.query(`select *, group_name from students, groups where groups.group_id = students.group_id`);
...
export const getStudentById = async (req, res) => {
    ...
    try {
        ...
        res.status(StatusCodes.BAD_REQUEST).json({ msg: `Student with ID = ${id} is not found` });
    }
};
...
export const updateStudent = async (req, res, next) => {
    ...
    if (!result.length) {
        return res.status(StatusCodes.BAD_REQUEST).json({ msg: `Student with ID = ${student_id} is not found` });
    }
...
export const updateGrade = async (req, res) => {
    ...
    try {
        ...
        return res.status(StatusCodes.BAD_REQUEST).json({ msg: `Grade updation failed` });
    }
...
export const setGrades = async (req, res) => {
    ...
    res.status(StatusCodes.OK).json({ msg: `Grade updation is successfully done` });
};